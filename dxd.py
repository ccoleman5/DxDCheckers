...
try:
 os.system("title @DXDTEAM Checkers | More : t.me/JohanVestige ")
except:pass
init(autoreset=True)
fr = Fore.RED
fb = Fore.BLUE
...
choice = input(f"""{fb}  
   ...
   / __ \_  __/ __ \/ ____/ /_  ___  _____/ /_____  __________
  / / / / |/_/ / / / /   / __ \/ _ \/ ___/ //_/ _ \/ ___/ ___/
 / /_/ />  </ /_/ / /___/ / / /  __/ /__/ ,< /  __/ /  (__  ) {fr}
/_____/_/|_/_____/\____/_/ /_/\___/\___/_/|_|\___/_/  /____/  
                                                                                                                  
    \033[90m~ For more tools : t.me/JohanVestige | ICQ : 757714557
    Ps: Proxyless !!
